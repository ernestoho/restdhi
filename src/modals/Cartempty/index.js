    ...
    <>
      ...
      >
        <div className="max-h-[97vh] overflow-y-auto md:w-[100%] sm:w-[100%]">
          <div className="bg-white_A700 flex flex-col justify-start p-[48px] md:px-[20px] sm:px-[20px] w-[100%]">
            ...
            <Img
              ...
              className="h-[152px] md:ml-[0] sm:ml-[0] ml-[119px] mt-[77px] w-[51%]"
              alt="Twenty"
            />
            <Text
              className="font-normal mb-[92px] md:ml-[0] sm:ml-[0] ml-[127px] mt-[44px] not-italic text-bluegray_400 text-left w-[auto]"
              as="h5"
              variant="h5"
            >
              No item. Add more
