    ...
    <>
      ...
      >
        <div className="max-h-[97vh] overflow-y-auto md:w-[100%] sm:w-[100%]">
          <div className="bg-white_A700 flex flex-col gap-[48px] items-center justify-center p-[48px] md:px-[20px] sm:px-[20px] w-[100%]">
            ...
            <div className="flex flex-col items-start justify-start mb-[16px] w-[100%]">
              ...
              >
                <div className="flex flex-1 sm:flex-col flex-row gap-[24px] items-start justify-between my-[0] w-[100%]">
                  <Img
                    ...
                    className="sm:flex-1 h-[118px] md:h-[auto] sm:h-[auto] object-cover sm:w-[100%] w-[auto]"
                    alt="Rectangle"
                  />
                  <div className="flex sm:flex-1 flex-col items-start justify-start pb-[4px] sm:w-[100%] w-[auto]">
                    ...
                    <div className="flex flex-row items-center justify-start mt-[24px] md:w-[100%] sm:w-[100%] w-[43%]">
                      <Button
              ...
              <div className="flex sm:flex-col flex-row gap-[16px] items-center justify-between mt-[32px] md:w-[100%] sm:w-[100%] w-[98%]">
                <Button
              ...
              <div className="flex flex-row gap-[24px] items-center justify-start mt-[32px] md:w-[100%] sm:w-[100%] w-[65%]">
                <Img
                  src="images/img_computer_1.svg"
                  className="h-[24px] w-[24px]"
                  alt="computer"
                />
                <div className="flex flex-col gap-[8px] items-start justify-end pr-[5px] pt-[5px] w-[83%]">
                  <Text
                    className="font-bold text-bluegray_900 text-left w-[auto]"
                    as="h5"
                    variant="h5"
