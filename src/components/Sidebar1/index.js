      ...
      <aside className={props.className}>
        <div className="bg-white_A700 flex flex-col gap-[36px] items-center justify-start p-[32px] sm:px-[20px] w-[100%]">
          <Img
            ...
            alt="Logo"
          />
          <div className="flex flex-col items-start justify-start mb-[418px] md:w-[100%] sm:w-[100%] w-[88%]">
            <div className="flex flex-row gap-[16px] items-center justify-start md:w-[100%] sm:w-[100%] w-[75%]">
              <Img
            ...
            <div className="flex flex-row gap-[16px] items-center justify-start mt-[34px] md:w-[100%] sm:w-[100%] w-[69%]">
              <Img
            ...
            <div className="flex flex-row gap-[32px] items-center justify-between mt-[32px] w-[100%]">
              ...
              <Text
                className="bg-red_600 flex font-bold font-poppins h-[24px] items-center justify-center rounded-radius50 text-center text-white_A700 w-[24px]"
                variant="body1"
              >
                3
              </Text>
            </div>
            <div className="flex flex-row gap-[16px] items-center justify-start mt-[31px] md:w-[100%] sm:w-[100%] w-[39%]">
              <Img
            ...
            <div className="flex flex-row gap-[16px] items-start justify-start mt-[32px] md:w-[100%] sm:w-[100%] w-[66%]">
              <Img
            ...
            <div className="flex flex-row gap-[16px] items-end justify-start mt-[34px] md:w-[100%] sm:w-[100%] w-[47%]">
              <Img
            ...
            <div className="flex flex-row gap-[16px] items-center justify-start mt-[33px] md:w-[100%] sm:w-[100%] w-[44%]">
              <Img
