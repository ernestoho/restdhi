          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] sm:px-[20px] w-[100%]">
            ...
            <div className="bg-gray_51 flex flex-col items-center justify-start p-[23px] sm:px-[20px] w-[100%]">
              <div className="flex flex-col gap-[35px] items-center justify-start mb-[72px] mt-[15px] w-[100%]">
                ...
                <div className="bg-white_A700 flex flex-col md:gap-[40px] sm:gap-[40px] gap-[80px] items-center justify-start p-[103px] sm:px-[20px] md:px-[40px] rounded-radius4 shadow-bs w-[100%]">
                  <Img
                    src="images/img_group18034.svg"
                    className="h-[215px] w-[23%]"
                    alt="Group18034"
                  />
                  <div className="flex flex-col gap-[32px] items-center justify-start mb-[130px] px-[7px] md:w-[100%] sm:w-[100%] w-[54%]">
                    <div className="flex flex-col gap-[13px] justify-start md:w-[100%] sm:w-[100%] w-[96%]">
                      <Text
