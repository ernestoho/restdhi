  ...
  return (
    <>
      <div className="bg-white_A700 font-inter h-[1024px] mx-[auto] relative w-[100%]">
        ...
        <div className="absolute flex md:flex-col sm:flex-col flex-row gap-[59px] h-[max-content] inset-[0] items-start justify-center m-[auto] max-w-[1260px] md:px-[20px] sm:px-[20px] w-[100%]">
          <div className="flex md:flex-1 sm:flex-1 flex-col gap-[132px] md:gap-[40px] sm:gap-[40px] justify-start md:mt-[0] sm:mt-[0] mt-[2px] md:w-[100%] sm:w-[100%] w-[50%]">
            <Text
              className="leading-[40.00px] md:ml-[0] sm:ml-[0] ml-[173px] text-bluegray_900 text-center sm:w-[100%] w-[50%]"
              as="h1"
              variant="h1"
            >
          ...
          <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col gap-[46px] items-center justify-end p-[44px] sm:px-[20px] md:px-[40px] rounded-radius20 shadow-bs1 md:w-[100%] sm:w-[100%] w-[46%]">
            <Text
            ...
            <div className="flex flex-col items-center justify-start md:w-[100%] sm:w-[100%] w-[88%]">
              <Button
              ...
              <div className="flex flex-row items-start justify-between mt-[54px] w-[100%]">
                <Line className="bg-indigo_51 h-[1px] my-[6px] w-[auto]" />
                <Text
              ...
              <div className="flex flex-col gap-[12px] items-start justify-start mt-[56px] md:w-[100%] sm:w-[100%] w-[98%]">
                <Text
              ...
              <div className="flex flex-col gap-[12px] items-start justify-start mt-[31px] md:w-[100%] sm:w-[100%] w-[98%]">
                <Text
                  className="font-medium text-bluegray_800 text-left w-[auto]"
                  as="h6"
                  variant="h6"
              ...
              <div className="flex flex-row items-start justify-between mt-[113px] md:w-[100%] sm:w-[100%] w-[99%]">
                <CheckBox
              ...
              <Button
                className="common-pointer cursor-pointer font-bold min-w-[414px] mt-[80px] text-[14px] text-center text-white_A700 w-[auto]"
