      ...
      <div className="flex flex-col font-inter items-center justify-start mx-[auto] w-[100%]">
        <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-start justify-evenly w-[100%]">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] sm:px-[20px] w-[100%]">
            ...
            <div className="bg-gray_51 flex flex-col font-poppins items-center justify-start p-[19px] w-[100%]">
                ...
                >
                  ...
                  {[...Array(3)].map((item, index) => (
                    <AccordionItem uuid={index} key={Math.random()}>
                      <div className="bg-white_A700 flex flex-1 flex-col gap-[31px] items-center justify-start py-[24px] rounded-radius4 shadow-bs w-[100%]">
                        <AccordionItemHeading className="w-full">
                          <AccordionItemButton>
                            <AccordionItemState>
                              {({ expanded }) => (
                                <div className="flex flex-col md:gap-[16px] sm:gap-[16px] items-center justify-between w-[100%]">
                                  <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-center justify-start md:w-[100%] sm:w-[100%] w-[auto]">
                                    <Img
                                      src="images/img_arrowup_24X24.svg"
                                      className="h-[24px] w-[24px]"
                                      alt="arrowup"
                                    />
                                    <div className="flex flex-row font-poppins items-center justify-center md:ml-[0] sm:ml-[0] ml-[16px] md:w-[100%] sm:w-[100%] w-[14%]">
                                      {expanded && (
                                        <Img
                                    ...
                                    <Button
                                      className="cursor-pointer font-semibold md:ml-[0] sm:ml-[0] ml-[797px] text-[14px] text-bluegray_800 text-center w-[98px]"
                        ...
                        <AccordionItemPanel className="w-full">
                          <div className="font-poppins gap-[20px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-4 items-center justify-start mb-[8px] md:w-[100%] sm:w-[100%] w-[95%]">
                            <div className="border-2 border-indigo_51 border-solid flex flex-col items-center justify-center p-[55px] sm:px-[20px] md:px-[40px] rounded-radius4 w-[100%]">
                            ...
                            <div className="bg-white_A700 flex flex-col items-center justify-start p-[31px] sm:px-[20px] rounded-radius4 shadow-bs w-[100%]">
                              <div className="flex flex-col items-start justify-start pt-[5px] w-[100%]">
                                <div className="flex flex-col gap-[12px] items-center justify-start md:w-[100%] sm:w-[100%] w-[93%]">
                                  <Text
                                ...
                                <div className="flex flex-col items-center justify-start mt-[24px] w-[100%]">
                                  <div className="flex flex-col gap-[24px] items-start justify-start w-[100%]">
                                    ...
                                    <div className="flex flex-row gap-[6px] items-center justify-between w-[100%]">
                                      <Line className="bg-indigo_401 h-[5px] w-[auto]" />
                                      <Line className="bg-indigo_401 h-[5px] w-[auto]" />
                                      <Line className="bg-indigo_401 h-[5px] w-[auto]" />
                                      <Line className="bg-indigo_401 h-[5px] w-[auto]" />
                                      <Line className="bg-indigo_51 h-[5px] w-[auto]" />
                                    </div>
                                  </div>
                                </div>
                                <div className="flex flex-row items-end justify-between mt-[28px] w-[100%]">
                                  <div className="flex flex-col gap-[19px] items-start justify-start w-[auto]">
                                    ...
                                    <div className="h-[32px] md:h-[auto] sm:h-[auto] relative rounded-radius16 w-[64%]">
                                      <Img
                                        src="images/img_robototoyfacefi.png"
                                        className="absolute h-[32px] inset-y-[0] left-[0] my-[auto] rounded-radius50 w-[32px]"
                                        alt="RobotoToyFaceFi"
                                      />
                                      <Img
                                        src="images/img_fidenza978toy.png"
                                        className="absolute h-[32px] inset-y-[0] my-[auto] right-[0] rounded-radius50 w-[32px]"
                                        alt="Fidenza978Toy"
                                      />
                                    </div>
                                  </div>
                                  <Button
                                    className="flex h-[32px] items-center justify-center mt-[35px] rounded-radius50 w-[32px]"
                                    size="mdIcn"
                            ...
                            <div className="bg-white_A700 flex flex-col items-center justify-start p-[31px] sm:px-[20px] rounded-radius4 shadow-bs w-[100%]">
                              <div className="flex flex-col items-start justify-start pt-[6px] w-[100%]">
                                <div className="flex flex-col gap-[12px] items-start justify-start md:w-[100%] sm:w-[100%] w-[93%]">
                                  <Text
                                    className="font-bold text-bluegray_900 text-left w-[auto]"
                                    as="h4"
                                    variant="h4"
                            ...
                            <div className="bg-white_A700 flex flex-col items-center justify-start p-[31px] sm:px-[20px] rounded-radius4 shadow-bs w-[100%]">
                              <div className="flex flex-col items-start justify-start pt-[4px] w-[100%]">
                                <div className="flex flex-col gap-[17px] items-start justify-start md:w-[100%] sm:w-[100%] w-[93%]">
                                  <Text
                                    className="font-bold text-bluegray_900 text-left w-[auto]"
                                    as="h4"
                                    variant="h4"
