        ...
        <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-center justify-evenly w-[100%]">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] sm:px-[20px] w-[100%]">
            ...
            <div className="bg-gray_51 flex flex-col items-center justify-start p-[23px] sm:px-[20px] w-[100%]">
              <div className="flex flex-col gap-[36px] items-center justify-start mb-[42px] mt-[14px] md:w-[100%] sm:w-[100%] w-[99%]">
                ...
                <div className="bg-white_A700 flex flex-col md:gap-[40px] sm:gap-[40px] gap-[65px] items-center justify-start p-[111px] sm:px-[20px] md:px-[40px] rounded-radius4 shadow-bs w-[100%]">
                  <Img
                    src="images/img_group18037.svg"
                    className="h-[208px] w-[28%]"
                    alt="Group18037"
                  />
                  <div className="flex flex-col gap-[32px] items-center justify-start mb-[143px] md:w-[100%] sm:w-[100%] w-[56%]">
                    <div className="flex flex-col gap-[8px] justify-start w-[100%]">
                      <Text
                        className="md:ml-[0] sm:ml-[0] ml-[48px] text-bluegray_900 text-left w-[auto]"
                        as="h2"
                        variant="h2"
                      >
                    ...
                    <Button
                      className="cursor-pointer font-bold min-w-[207px] text-[14px] text-center text-white_A700 w-[auto]"
