              ...
              <div className="flex flex-col gap-[35px] items-center justify-start mb-[75px] mt-[15px] w-[100%]">
                ...
                <div className="bg-white_A700 flex flex-col gap-[58px] items-center justify-start p-[80px] sm:px-[20px] md:px-[40px] rounded-radius4 shadow-bs w-[100%]">
                  ...
                  <div className="flex flex-col items-center justify-start mb-[60px] md:w-[100%] sm:w-[100%] w-[46%]">
                    ...
                    >
                      <div
                        className="common-pointer bg-white_A700 hover:border hover:border-indigo_51 hover:border-solid hover:cursor-pointer flex flex-1 flex-row items-center justify-between hover:my-[0] my-[0] p-[25px] sm:px-[20px] rounded-radius4 hover:shadow-bs5 shadow-bs5 w-[100%]"
                      ...
                      <div className="bg-white_A700 hover:border border hover:border-indigo_51 border-indigo_51 hover:border-solid border-solid hover:cursor-pointer flex flex-1 flex-row items-center justify-between hover:my-[0] my-[0] p-[25px] sm:px-[20px] rounded-radius4 hover:shadow-bs5 shadow-bs5 w-[100%]">
                        <div className="flex flex-row gap-[20px] items-center justify-center ml-[7px] rounded-radius4 w-[auto]">
                          <Img
