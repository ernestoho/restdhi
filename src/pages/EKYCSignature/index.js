            ...
            <div className="bg-gray_51 flex flex-col items-center justify-start p-[23px] sm:px-[20px] w-[100%]">
              <div className="flex flex-col gap-[35px] items-center justify-start mb-[72px] mt-[15px] w-[100%]">
                ...
                <div className="bg-white_A700 flex flex-col items-center justify-start p-[48px] sm:px-[20px] md:px-[40px] rounded-radius4 shadow-bs w-[100%]">
                  <div className="flex flex-col gap-[21px] items-center justify-start md:w-[100%] sm:w-[100%] w-[31%]">
                    <Text
                  ...
                  <div className="bg-gray_51 border-2 border-dashed border-indigo_51 flex flex-col items-end justify-end mt-[40px] p-[32px] sm:px-[20px] rounded-radius4 md:w-[100%] sm:w-[100%] w-[65%]">
                    <div className="flex flex-col gap-[36px] justify-start mt-[79px] md:w-[100%] sm:w-[100%] w-[95%]">
                      <Img
                        src="images/img_signatureofka.png"
                        className="h-[236px] sm:h-[auto] mr-[47px] object-cover md:w-[100%] sm:w-[100%] w-[92%]"
                        alt="SignatureofKa"
                      />
                      <div className="flex flex-row gap-[24px] items-center justify-end ml-[auto] md:w-[100%] sm:w-[100%] w-[23%]">
                        <Button
