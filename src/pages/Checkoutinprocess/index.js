      ...
      <div className="bg-white_A700 flex flex-col font-inter items-center justify-start mx-[auto] w-[100%]">
        <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-center justify-evenly w-[100%]">
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] sm:px-[20px] w-[100%]">
            ...
            <div
              className="common-pointer bg-gray_51 flex flex-col items-center justify-start p-[23px] sm:px-[20px] w-[100%]"
              onClick={() => navigate("/checkoutsuccessful")}
            >
              <div className="flex flex-col gap-[36px] items-center justify-start mb-[42px] mt-[14px] md:w-[100%] sm:w-[100%] w-[99%]">
                ...
                <div className="bg-white_A700 flex flex-col gap-[16px] items-center justify-start p-[114px] sm:px-[20px] md:px-[40px] rounded-radius4 shadow-bs w-[100%]">
                  <Img
                    src="images/img_creditcardpay.svg"
                    className="h-[270px] w-[270px]"
                    alt="creditcardpay"
                  />
                  <div className="flex flex-col gap-[13px] items-center justify-start mb-[226px] pt-[4px] px-[4px] md:w-[100%] sm:w-[100%] w-[58%]">
                    <Text
