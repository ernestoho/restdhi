                  ...
                  <div className="flex flex-col items-center justify-start mb-[16px] mt-[20px] w-[100%]">
                    ...
                    <div className="flex md:flex-col sm:flex-col flex-row gap-[20px] items-center justify-between mt-[40px] w-[100%]">
                      <div className="h-[359px] md:h-[auto] sm:h-[auto] relative sm:w-[100%] w-[auto]">
                        ...
                        <div className="absolute border-2 border-dashed border-indigo_51 flex flex-col h-[max-content] inset-[0] items-center justify-center m-[auto] p-[108px] sm:px-[20px] md:px-[40px] rounded-radius4 w-[100%]">
                          <div className="flex flex-col gap-[24px] items-center justify-start mt-[19px] md:w-[100%] sm:w-[100%] w-[47%]">
                            <Button
                      ...
                      <div className="flex md:h-[358px] sm:h-[358px] h-[359px] justify-end relative sm:w-[100%] w-[auto]">
                        ...
                        <div className="absolute border-2 border-dashed border-indigo_51 flex flex-col h-[max-content] inset-[0] items-center justify-center m-[auto] p-[36px] sm:px-[20px] rounded-radius4 w-[100%]">
                          <Text
