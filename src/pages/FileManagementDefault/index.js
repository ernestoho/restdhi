        ...
        <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-start justify-evenly w-[100%]">
          <aside className="flex flex-col md:hidden sm:hidden md:px-[20px] sm:px-[20px] w-[241px]">
            <div className="flex flex-col gap-[36px] items-center justify-start mb-[426px] ml-[32px] mr-[54px] mt-[36px] w-[65%]">
              ...
              <div className="flex flex-col items-start justify-start w-[100%]">
                ...
                <div className="flex flex-row gap-[16px] items-center justify-start mt-[32px] md:w-[100%] sm:w-[100%] w-[39%]">
                  <Img
          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] sm:px-[20px] w-[100%]">
            ...
            <div className="bg-gray_51 flex flex-col font-poppins items-center justify-start p-[23px] sm:px-[20px] w-[100%]">
              <div className="flex md:flex-col sm:flex-col flex-row md:gap-[40px] sm:gap-[40px] items-end justify-between mb-[75px] mt-[16px] w-[100%]">
                <div className="flex md:flex-1 sm:flex-1 flex-col gap-[20px] items-center justify-start md:w-[100%] sm:w-[100%] w-[auto]">
                        ...
                        >
                          ...
                          {[...Array(3)].map((item, index) => (
                            <AccordionItem uuid={index} key={Math.random()}>
                              <div className="flex flex-1 flex-col gap-[21px] justify-start w-[100%]">
                                ...
                                <AccordionItemPanel className="w-full">
                                  <div className="flex flex-col font-poppins items-start justify-start md:ml-[0] sm:ml-[0] ml-[36px] md:w-[100%] sm:w-[100%] w-[59%]">
                                    <Text
                  ...
                  <div className="bg-white_A700 flex flex-col font-inter justify-start p-[16px] rounded-radius4 shadow-bs w-[100%]">
                    <Img
                      src="images/img_plus_1.svg"
                      className="h-[24px] md:ml-[0] sm:ml-[0] ml-[217px] w-[24px]"
                      alt="plus"
                    />
                    <Img
                      src="images/img_document1.png"
                      className="h-[81px] md:h-[auto] sm:h-[auto] md:ml-[0] sm:ml-[0] ml-[80px] mt-[2px] object-cover w-[81px]"
                      alt="documentOne"
                    />
                    <div className="flex flex-col gap-[8px] items-center justify-start mt-[40px] mx-[auto] md:w-[100%] sm:w-[100%] w-[95%]">
                      <Text
                    ...
                    <Button
                      className="flex items-center justify-center mb-[16px] md:ml-[0] ml-[59px] mt-[44px] sm:ml-[0] text-center"
                      rightIcon={
                        <Img
                      ...
                      size="sm"
                    >
                      <div className="bg-transparent cursor-pointer font-bold text-[14px] text-deep_orange_300 text-left">
                        Upgrade now
                      </div>
                    </Button>
                  </div>
                </div>
                <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col font-inter items-center justify-start md:mt-[0] sm:mt-[0] mt-[56px] p-[26px] sm:px-[20px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                  <div className="flex flex-col gap-[35px] items-center justify-start mb-[16px] md:w-[100%] sm:w-[100%] w-[98%]">
                    <div className="flex flex-col items-center justify-start w-[100%]">
                      <div className="flex flex-col gap-[26px] items-center justify-start w-[100%]">
                        <div className="flex sm:flex-col flex-row sm:gap-[20px] items-center justify-start w-[100%]">
                          ...
                          <Button
                            className="flex h-[40px] items-center justify-center sm:ml-[0] ml-[326px] rounded-radius50 w-[40px]"
                            size="lgIcn"
                          ...
                          <Button
                            className="flex h-[40px] items-center justify-center sm:ml-[0] ml-[16px] rounded-radius50 w-[40px]"
                            size="lgIcn"
                            variant="icbFillGray51"
                          >
                            <Img
                        ...
                        <div className="flex flex-col items-center justify-start w-[100%]">
                          <div className="gap-[20px] grid sm:grid-cols-1 grid-cols-2 justify-center min-h-[auto] w-[100%]">
                            <div
                              className="common-pointer bg-white_A700 border border-indigo_51 border-solid flex flex-1 flex-col items-center justify-start p-[20px] rounded-radius4 w-[100%]"
                            ...
                            <div className="bg-white_A700 border border-indigo_51 border-solid flex flex-1 flex-col items-center justify-start p-[20px] rounded-radius4 w-[100%]">
                              <div className="flex flex-col gap-[32px] items-center justify-start w-[100%]">
                                <div className="flex flex-row items-center justify-between w-[100%]">
                                  <Img
                                    src="images/img_folder_24X24.svg"
                    ...
                    <div className="flex flex-col items-center justify-start w-[100%]">
                      <div className="flex flex-col items-center justify-start w-[100%]">
                        <div className="flex flex-col items-center justify-start w-[100%]">
                          ...
                          <div className="flex sm:flex-col flex-row sm:gap-[20px] items-center justify-start mt-[35px] pr-[3px] py-[3px] md:w-[100%] sm:w-[100%] w-[93%]">
                            <Text
                              className="font-normal not-italic text-bluegray_400 text-left w-[auto]"
                              as="h5"
                              variant="h5"
                          ...
                          <div className="bg-gray_51 flex flex-col items-start justify-start mt-[16px] p-[20px] w-[100%]">
                            <div className="flex sm:flex-col flex-row sm:gap-[20px] items-end justify-start md:w-[100%] sm:w-[100%] w-[92%]">
                          ...
                          <div className="bg-white_A700 flex flex-col items-start justify-start p-[20px] w-[100%]">
                            <div className="flex sm:flex-col flex-row sm:gap-[20px] items-end justify-start md:w-[100%] sm:w-[100%] w-[93%]">
                              <Radio
                                value="imagepng"
                                className="font-normal not-italic text-[16px] text-bluegray_900 text-left sm:w-[100%]"
                        ...
                        <div className="bg-gray_51 flex flex-col items-start justify-start p-[20px] w-[100%]">
                          <div className="flex sm:flex-col flex-row sm:gap-[20px] items-end justify-start md:w-[100%] sm:w-[100%] w-[91%]">
                ...
                <div className="bg-white_A700 flex md:flex-1 sm:flex-1 flex-col font-inter items-start justify-end md:mt-[0] sm:mt-[0] mt-[56px] p-[31px] sm:px-[20px] rounded-radius4 shadow-bs md:w-[100%] sm:w-[100%] w-[auto]">
                  <Text
                  ...
                  <div className="md:h-[222px] sm:h-[222px] h-[485px] mt-[32px] relative w-[100%]">
                    <div className="absolute h-[190px] md:h-[auto] sm:h-[auto] inset-x-[0] mx-[auto] top-[0] w-[190px]">
                      <CircularProgressbar
                      ...
                      ></CircularProgressbar>
                      <div className="absolute flex flex-col gap-[8px] inset-x-[0] items-center justify-start mx-[auto] top-[34%] w-[50%]">
                        <Text
                  ...
                  <div className="border-2 border-indigo_51 border-solid flex flex-col items-center justify-start mt-[32px] p-[35px] sm:px-[20px] rounded-radius4 w-[100%]">
                    <div className="flex flex-col gap-[17px] items-center justify-start md:w-[100%] sm:w-[100%] w-[49%]">
                      <Img
