          ...
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] sm:px-[20px] w-[100%]">
            ...
            <div className="bg-gray_51 flex flex-col items-center justify-start p-[23px] sm:px-[20px] w-[100%]">
              <div className="flex flex-col gap-[35px] items-center justify-start mb-[72px] mt-[15px] w-[100%]">
                ...
                <div className="bg-white_A700 flex flex-col gap-[40px] items-center justify-start p-[48px] sm:px-[20px] md:px-[40px] rounded-radius4 shadow-bs w-[100%]">
                  <div className="flex flex-col gap-[20px] items-center justify-end p-[4px] md:w-[100%] sm:w-[100%] w-[29%]">
                    <Text
                  ...
                  <div className="md:h-[377px] sm:h-[377px] h-[567px] relative md:w-[100%] sm:w-[100%] w-[56%]">
                    <div
                      className="absolute bg-cover bg-no-repeat flex flex-col inset-x-[0] items-center justify-start mx-[auto] rounded-radius4 top-[0] w-[100%]"
                      style={{
                        backgroundImage: "url('images/img_group16121.png')",
                      }}
                    >
                      <div
                        className="bg-cover bg-no-repeat md:h-[377px] sm:h-[377px] h-[504px] p-[62px] sm:px-[20px] md:px-[40px] relative w-[100%]"
                        style={{
                          backgroundImage: "url('images/img_group16122.svg')",
                        }}
                      >
                        <Img
                          src="images/img_group_white_A700_377X459.svg"
                          className="absolute h-[377px] inset-[0] justify-center m-[auto] w-[79%]"
                          alt="Group One"
                        />
                      </div>
                    </div>
                    <Button
                      className="absolute bottom-[0] flex h-[80px] inset-x-[0] items-center justify-center mx-[auto] rounded-radius50 w-[80px]"
                      size="3xlIcn"
