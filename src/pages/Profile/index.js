    ...
    <>
      <div className="bg-white_A700 flex flex-col font-inter items-center justify-end mx-[auto] w-[100%]">
        <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-center justify-evenly w-[100%]">
          <aside className="flex flex-col md:hidden sm:hidden md:px-[20px] sm:px-[20px] w-[241px]">
            <div className="bg-white_A700 flex flex-col gap-[36px] items-center justify-start p-[32px] sm:px-[20px] w-[100%]">
              <Img
                ...
                alt="Logo"
              />
              <div className="flex flex-col items-start justify-start mb-[506px] md:w-[100%] sm:w-[100%] w-[88%]">
                <div
          ...
          <Line className="bg-indigo_51 flex-1 md:h-[100%] sm:h-[100%] h-[1038px] w-[100%]" />
          <div className="flex flex-1 flex-col items-center justify-start md:px-[20px] sm:px-[20px] w-[100%]">
            <Header className="bg-white_A700 flex items-center justify-center w-[100%]" />
            <div className="bg-gray_51 flex flex-col font-poppins items-center justify-end p-[10px] w-[100%]">
              <div className="flex md:flex-col sm:flex-col flex-row gap-[21px] items-end justify-between mt-[27px] md:w-[100%] sm:w-[100%] w-[98%]">
                <div className="flex flex-col items-start justify-start md:w-[100%] sm:w-[100%] w-[auto]">
                  ...
                  <div className="bg-white_A700 flex flex-col font-inter items-center justify-start mt-[37px] pb-[36px] rounded-radius4 shadow-bs w-[100%]">
                    <div className="md:h-[136px] sm:h-[136px] h-[196px] relative w-[100%]">
                      <Img
                        src="images/img_imglibimg1.png"
                        className="absolute h-[136px] inset-x-[0] mx-[auto] object-cover top-[0] w-[100%]"
                        alt="ImgLibIMGOne"
                      />
                      <Img
                        src="images/img_sherlocktoyfa.png"
                        className="absolute bottom-[0] h-[120px] inset-x-[0] mx-[auto] object-cover rounded-radius24 w-[120px]"
                        alt="SherlockToyFa One"
                      />
                    </div>
                    <div className="flex flex-col gap-[24px] items-center justify-start mt-[24px] md:w-[100%] sm:w-[100%] w-[72%]">
                      ...
                      <div className="flex flex-row items-center justify-center md:w-[100%] sm:w-[100%] w-[50%]">
                        <Img
                  ...
                  <div className="bg-white_A700 flex flex-col font-inter items-center justify-end mt-[21px] p-[24px] sm:px-[20px] rounded-radius4 shadow-bs4 w-[100%]">
                    <div className="flex flex-col gap-[28px] items-center justify-start mt-[8px] md:w-[100%] sm:w-[100%] w-[96%]">
                ...
                <div className="flex flex-col font-inter gap-[21px] items-center justify-start md:mt-[0] sm:mt-[0] mt-[57px] md:w-[100%] sm:w-[100%] w-[auto]">
                  <List
                    className="sm:flex-col flex-row gap-[18px] grid md:grid-cols-1 sm:grid-cols-1 grid-cols-2 justify-center w-[100%]"
                    orientation="horizontal"
                  >
                    <div className="bg-white_A700 flex flex-1 flex-col items-center justify-start sm:ml-[0] p-[32px] sm:px-[20px] rounded-radius4 shadow-bs4 w-[100%]">
                      <div className="flex flex-row items-center justify-between w-[100%]">
                        <div className="flex flex-row gap-[20px] items-center justify-between w-[auto]">
                          <Button
                  ...
                  <div className="bg-white_A700 flex flex-col items-center justify-end p-[29px] sm:px-[20px] rounded-radius4 shadow-bs4 w-[100%]">
                    <div className="flex flex-col gap-[31px] items-center justify-start mt-[3px] w-[100%]">
                      <div className="flex md:flex-col sm:flex-col flex-row md:gap-[20px] sm:gap-[20px] items-end justify-start w-[100%]">
                        <Text
                          className="font-bold md:mt-[0] sm:mt-[0] my-[5px] text-bluegray_900 text-left w-[auto]"
                          as="h4"
                          variant="h4"
                        >
                          My projects
                        ...
                        <Img
                          ...
                          className="h-[32px] md:ml-[0] sm:ml-[0] ml-[505px] w-[32px]"
                          alt="search"
                        />
                        <Img
                          src="images/img_user_32X32.svg"
                          className="h-[32px] md:ml-[0] sm:ml-[0] ml-[24px] w-[32px]"
                          alt="user Four"
                        />
                      </div>
                      <div className="flex flex-col gap-[16px] items-center justify-start w-[100%]">
                        ...
                        <div className="h-[24px] md:h-[auto] sm:h-[auto] relative w-[24px]">
                          <Img
